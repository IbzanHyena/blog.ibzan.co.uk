...
- an _noun_ is data of some kind, like a number of a string, organised in an array;
...
If you want to learn more, check the J wiki page on [parts of speech][parts-of-speech].
